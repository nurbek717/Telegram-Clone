					...
					>
						...
						{message.text.length > 0 && (
							<p
								className={cn(
									'text-sm',
									// Own messages: blue bubble, need white text
									message.receiver._id === currentContact?._id ? 'text-white' : 'text-foreground'
								)}
							>
								{message.text}
							</p>
						...
						<div
							className={cn(
								'right-1 bottom-0 absolute opacity-60 text-[9px] flex gap-[3px]',
								message.receiver._id === currentContact?._id ? 'text-white' : 'text-foreground'
							)}
						>
